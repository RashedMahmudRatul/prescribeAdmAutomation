...
public class TC004_GenericManagenent_Medicine extends BaseClass{
  
  @Test(priority = -1)

	public void Medicine() throws InterruptedException, IOException {
	  readConfig();
		String path = prop.getProperty("Coppied");
		File file = new File(path);
		FileInputStream fis = new FileInputStream(file);
		XSSFWorkbook wb = new XSSFWorkbook(fis);
		XSSFSheet sheet = wb.getSheet("Medicine");
